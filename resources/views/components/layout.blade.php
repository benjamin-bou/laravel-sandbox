    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                {{-- Ajoute ":" devant active, transformera le string "false" en booléen false --}}
        ...
        <header class="bg-white shadow-sm">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <!-- Le nom de la variable $title est un choix, on peut créer n'importe quelle variable -->
            </div>
        </header>
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                {{ $slot }}
                <!-- Pour récupérer le contenu de chaque page -->
            </div>
        </main>
    </div>
